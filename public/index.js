...
const formEl = document.querySelector("#FirstForm");
...
const PrintResult = (PLAN, Addons) => {
    ...
    TOTAL.innerHTML = `<span>Total:</span><span>${TotalValue}/yr</span>`;
};
boxLIST.forEach(box => {
    let boxEl = box;
...
Next3.addEventListener("click", () => {
    ...
    let FirstAddon = AddonList[0];
    let SecondAddon = AddonList[1];
    let ThirdAddon = AddonList[2];
